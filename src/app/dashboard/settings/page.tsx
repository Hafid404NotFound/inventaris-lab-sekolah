  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-slate-600 mt-1">Kelola pengaturan akun dan aplikasi</p>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
        ...
        <div className="p-6">
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-6">
                ...
                <div>
                  ...
                  <p className="text-slate-600 capitalize">{user?.role?.replace('_', ' ')}</p>
                </div>
              </div>
          ...
          {activeTab === 'school' && (
            <div className="space-y-6">
              <div className="flex items-center gap-6">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-slate-800">Logo Sekolah</h3>
                  <p className="text-slate-600 text-sm">Format: PNG, JPG (Max 2MB)</p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-slate-700 mb-2">Email Sekolah</label>
                  <input
                    type="email"
          ...
          {activeTab === 'notifications' && (
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                {[
                  { id: 'stock_alert', label: 'Peringatan Stok Menipis', description: 'Dapatkan notifikasi saat item mencapai minimum stok' },
                  { id: 'expiring_items', label: 'Item Kadaluarsa', description: 'Dapatkan notifikasi untuk item yang akan kadaluarsa' },
                  { id: 'loan_reminders', label: 'Pengingat Peminjaman', description: 'Dapatkan pengingat untuk peminjaman yang belum dikembalikan' },
                  { id: 'damage_reports', label: 'Laporan Kerusakan', description: 'Dapatkan notifikasi saat ada laporan kerusakan' },
                  { id: 'new_loans', label: 'Peminjaman Baru', description: 'Dapatkan notifikasi saat ada peminjaman baru' },
                ].map((item) => (
              ...
              <div className="border-t border-slate-200 pt-6">
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between p-4 bg-slate-50 rounded-lg">
                    <div>
                      <p className="font-medium text-slate-800">Chrome di Windows</p>
                      <p className="text-sm text-slate-600">Jakarta, Indonesia • Aktif sekarang</p>
                    </div>
                    <span className="text-sm text-emerald-600 font-medium">Sesi ini</span>
                  </div>
                  <div className="flex items-center justify-between p-4 bg-slate-50 rounded-lg">
                    <div>
                      <p className="font-medium text-slate-800">Firefox di Android</p>
                      <p className="text-sm text-slate-600">Jakarta, Indonesia • 2 hari lalu</p>
                    </div>
          ...
          {activeTab === 'system' && (
            <div className="space-y-6">
              <h3 className="font-semibold text-slate-800">Pengaturan Sistem</h3>
              ...
              <div className="border-t border-slate-200 pt-6">
                ...
                <div className="grid grid-cols-3 gap-4">
                  {[
                    { id: 'light', name: 'Terang', bg: 'bg-white border-slate-300' },
                    { id: 'dark', name: 'Gelap', bg: 'bg-slate-800 border-slate-700' },
                    { id: 'auto', name: 'Otomatis', bg: 'bg-gradient-to-r from-white to-slate-800 border-slate-300' },
                  ].map((theme) => (
                    <button
                      key={theme.id}
                      className={`p-4 rounded-lg border-2 transition ${
                        theme.id === 'light' ? 'border-emerald-500' : 'border-transparent'
                      }`}
                    >
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between p-4 bg-slate-50 rounded-lg">
                    <div>
                      ...
                      <p className="text-sm text-slate-600">Download semua data dalam format JSON</p>
                    </div>
                  ...
                  <div className="flex items-center justify-between p-4 bg-red-50 rounded-lg">
                    <div>
                      ...
                      <p className="text-sm text-red-600">Hapus semua data dan reset ke default</p>
                    </div>
                    <button className="text-red-600 hover:text-red-700 text-sm font-medium">
                      Reset
                    </button>
