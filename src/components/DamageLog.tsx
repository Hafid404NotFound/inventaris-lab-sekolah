          ...
          damages.map((damage) => (
            ...
            >
              <div className="flex items-start justify-between mb-3">
                ...
                <span
                  className={`px-2 py-1 rounded-full text-xs font-medium ${getConditionColor(damage.condition)}`}
                >
              ...
              <div className="grid grid-cols-2 gap-4 mb-3">
                ...
                <div className="flex items-center gap-2 text-sm text-slate-600">
                  ...
                  <span>
                    {new Date(damage.reportedAt).toLocaleDateString("id-ID")}
                  </span>
                </div>
              </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setNewDamage({ ...newDamage, itemId: e.target.value })
                  }
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setNewDamage({ ...newDamage, itemName: e.target.value })
                  }
                  className="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 outline-none"
